...
```
Esta es una advertencia, ya que podría ser que el `poder_pais` no explique el `voto` después de todo, lo que haría que nuestros hallazgos iniciales fueran espurios.
